...
int main(void)
{
	int intArray[8]; //randomly chosen numbers to sort
    int numOfElements; //to tell the function bubble sort how many elements are in the array
    int (* compare_function[])(int, int) = {low_to_high_compare, high_to_low_compare, absolute_low_to_high_compare, absolute_high_to_low_compare}; 
    ...
    for(size_t j = 0; j < 4; j++) //iteratess through funstions
    {
        bubble_sort(intArray, sizeof(intArray), (*compare_function[j])); //passes address of array of functions
